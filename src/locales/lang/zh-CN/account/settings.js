export default {
  ...
  'account.settings.basic.username': '姓名',
  'account.settings.basic.username-message': '请输入您的姓名!',
  'account.settings.basic.uid': '学号  请注意 ：学号为注册账号注册错误应注销账户重新注册ヽ(*。>Д<)o゜',
  'account.settings.basic.uid-message': '请注意学号为注册账号没有错误请勿轻易修改!',
  'account.settings.basic.college': '学院',
  'account.settings.basic.code': '邀请码',
  'account.settings.basic.college-message': '请输入您的学院!',
  'account.settings.basic.grade': '年级',
  'account.settings.basic.grade-message': '请输入您的年级!',
  'account.settings.basic.subject': '专业',
  'account.settings.basic.subject-message': '请输入您的专业!',
